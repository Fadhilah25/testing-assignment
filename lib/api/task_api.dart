...
class TaskApiService {
  ...
  static const String _baseUrl = 'https://frbwtxgklivvssojtpvw.supabase.co';
  static const String _apiKey =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImZyYnd0eGdrbGl2dnNzb2p0cHZ3Iiwicm9sZSI6ImFub24iLCJpYXQiOjE3NjUyODUwMjksImV4cCI6MjA4MDg2MTAyOX0.tjBLV9kGp2NbWluKpU8OOf4eOWN21F6CHMCcsNEQdCg';

  String? _accessToken;

  // Build headers untuk API requests
  Map<String, String> _getHeaders(
      {bool includeAuth = true, bool returnRepresentation = false}) {
    final headers = {
      'apikey': _apiKey,
